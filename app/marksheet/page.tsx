...
export default function MarksheetPage() {
  ...
  const sendAllMarksheets = async (committee: CommitteeData) => {
    ...
    try {
      ...
      await emailjs.init(process.env.NEXT_PUBLIC_EMAILJS_USER_ID);
      ...
      const results = await Promise.allSettled(
        delegates.map(async (delegate) => {
          try {
            ...
            const emailHtml = generateMarksheetEmail(committee.name, delegate, committee.marks);
            ...
            const response = await emailjs.send(
              ...
              process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID,
              {
                ...
                to_name: delegate.country,
                subject: `Your KIMUN ${committee.name} Marksheet`,
                message: emailHtml
              }
            );
  ...
  function getAwardForDelegate(delegate: Mark, allMarks: Mark[]): string {
  ...
  function generateMarksheetEmail(committeeName: string, delegate: Mark, allMarks: Mark[]) {
