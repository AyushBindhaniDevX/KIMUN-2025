            ...
            {["Home", "About", "Registration", "Matrix", "Resources", "Committees"].map(
              (item) => (
                <Link
                  ...
                  className={`${item === "Committees" ? "text-amber-400" : "text-amber-100"} hover:text-amber-400 transition-colors relative group`}
                >
                  {item}
                  <span className={`absolute -bottom-1 left-0 w-${item === "Committees" ? "full" : "0"} h-0.5 bg-amber-400 transition-all group-hover:w-full`}></span>
                </Link>
              ),
            )}
          </nav>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/committees" className="text-amber-400 hover:text-amber-300 transition-colors">
                    Committees
                  </Link>
                </li>
              </ul>
