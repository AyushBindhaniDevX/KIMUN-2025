...
import { 
  ...
  Scale, Gavel, Globe2, Info, Award, ChevronDown
} from 'lucide-react'
          ...
          >
            ...
            {step === 1 && (
              <div className="space-y-8">
                ...
                <Button onClick={() => setStep(2)} className="w-full h-14 text-base">Next: Fill Details <ChevronRight className="ml-3" /></Button>
              </div>
            )}
            ...
            {step === 5 && (
              <div className="space-y-8">
                ...
                <div className="flex gap-4 md:gap-6 flex-col md:flex-row pt-6 border-t border-gray-50">
                   ...
                   >
                      Complete Registration <ArrowRight className="ml-3" />
                   </Button>
                </div>
              </div>
            )}
...
function DelegateForm({ title, data, onChange, delegate }: any) {
  return (
    <div className="space-y-6">
