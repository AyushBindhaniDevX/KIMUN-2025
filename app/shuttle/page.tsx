    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto p-6 pt-24 relative z-10">
        <motion.div
          ...
          className="bg-white backdrop-blur-sm border border-border rounded-2xl shadow-lg p-8"
        >
          {step === 0 && (
            <motion.div
              key="step0"
            ...
            >
              <h1 className="text-3xl font-bold text-primary mb-6 flex items-center gap-2">
                <Calendar className="text-primary" /> Select Travel Date(s)
              </h1>
              ...
              <div className="space-y-4">
                {EVENT_DAYS.map(day => (
                  <motion.div
                    ...
                    className={`bg-slate-50 border rounded-xl p-4 cursor-pointer transition-colors ${
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <div>
                          <p className="text-slate-800">{day.date}</p>
                          <p className="text-sm text-slate-500">Event Day {day.id === 'day1' ? 1 : 2}</p>
                        </div>
                      </div>
                      {bookingDetails.days.includes(day.value) && (
              ...
              <Button
                ...
                className="w-full bg-primary hover:bg-sky-800 text-primary-foreground py-6 rounded-xl text-lg group"
              >
                Next: Select Route
          ...
          {step === 1 && (
            ...
            >
              <h1 className="text-3xl font-bold text-primary mb-6 flex items-center gap-2">
                <Bus className="text-primary" /> Select Shuttle Route
              </h1>
              ...
              <div className="space-y-4">
                {BUS_ROUTES.map(route => (
                  <motion.div
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className={`bg-slate-50 border border-border rounded-xl p-6 cursor-pointer hover:border-primary/40 transition-colors ${
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-slate-600">₹{route.price} per seat per day</p>
                      </div>
              ...
              <div className="flex gap-4">
                <Button
                  onClick={() => setStep(0)}
                  variant="outline"
                  className="flex-1 border-primary text-primary hover:bg-primary/10 hover:text-primary py-6 rounded-xl text-lg"
                >
                  Back
                </Button>
                <Button
                  onClick={() => validateStep(1) ? setStep(2) : alert('Please select a route')}
                  className="flex-1 bg-primary hover:bg-sky-800 text-primary-foreground py-6 rounded-xl text-lg group"
                >
